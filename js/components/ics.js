...
class IC74HC595Component extends Component {
  getPins() {
    return [
      { id: 'SER', label: 'SER', type: PIN_TYPE.DIGITAL, x: 0, y: 50, side: 'bottom' },
      { id: 'OE', label: '/OE', type: PIN_TYPE.DIGITAL, x: 17, y: 50, side: 'bottom' },
      { id: 'SRCLR', label: '/RST', type: PIN_TYPE.DIGITAL, x: 34, y: 50, side: 'bottom' },
      { id: 'SRCLK', label: 'SRCLK', type: PIN_TYPE.DIGITAL, x: 51, y: 50, side: 'bottom' },
      { id: 'RCLK', label: 'RCLK', type: PIN_TYPE.DIGITAL, x: 68, y: 50, side: 'bottom' },
      { id: 'GND', label: 'GND', type: PIN_TYPE.GND, x: 102, y: 50, side: 'bottom' },
      { id: 'VCC', label: 'VCC', type: PIN_TYPE.POWER, x: 0, y: 0, side: 'top' },
      { id: 'QHn', label: "Q7'", type: PIN_TYPE.DIGITAL, x: 17, y: 0, side: 'top' },
      { id: 'QA', label: 'Q0', type: PIN_TYPE.DIGITAL, x: 34, y: 0, side: 'top' },
      { id: 'QB', label: 'Q1', type: PIN_TYPE.DIGITAL, x: 51, y: 0, side: 'top' },
      { id: 'QC', label: 'Q2', type: PIN_TYPE.DIGITAL, x: 68, y: 0, side: 'top' },
      { id: 'QD', label: 'Q3', type: PIN_TYPE.DIGITAL, x: 85, y: 0, side: 'top' },
      { id: 'QE', label: 'Q4', type: PIN_TYPE.DIGITAL, x: 102, y: 0, side: 'top' },
      { id: 'QF', label: 'Q5', type: PIN_TYPE.DIGITAL, x: 119, y: 0, side: 'top' },
      { id: 'QG', label: 'Q6', type: PIN_TYPE.DIGITAL, x: 136, y: 0, side: 'top' },
      { id: 'QH', label: 'Q7', type: PIN_TYPE.DIGITAL, x: 153, y: 0, side: 'top' },
    ];
  }
  update(canvas) {
    const sim = window.ArduinoSim;
