...
defComp({
  ...
  pins: [
    ...
    { id: 'A0',   label: 'A0 (PA0)',   type: PIN_TYPE.ANALOG,  x: 18, y: 35,  side: 'left' },
    { id: 'A1',   label: 'A1 (PA4)',   type: PIN_TYPE.ANALOG,  x: 18, y: 54,  side: 'left' },
    { id: 'A2',   label: 'A2 (PA5)',   type: PIN_TYPE.ANALOG,  x: 18, y: 73,  side: 'left' },
    { id: 'A3',   label: 'A3 (PA6)',   type: PIN_TYPE.ANALOG,  x: 18, y: 92,  side: 'left' },
    { id: 'A4',   label: 'A4 (PA7)',   type: PIN_TYPE.ANALOG,  x: 18, y: 111, side: 'left' },
    { id: 'A5',   label: 'A5 (PC4)',   type: PIN_TYPE.ANALOG,  x: 18, y: 130, side: 'left' },
    { id: 'D0',   label: 'D0 (PC7)',   type: PIN_TYPE.SIGNAL,  x: 18, y: 154, side: 'left' },
    { id: 'D1',   label: 'D1 (PC6)',   type: PIN_TYPE.SIGNAL,  x: 18, y: 173, side: 'left' },
    { id: 'D2',   label: 'D2 (PG6)',   type: PIN_TYPE.DIGITAL, x: 18, y: 192, side: 'left' },
    { id: 'D3',   label: 'D3 (PD12)',  type: PIN_TYPE.PWM,     x: 18, y: 211, side: 'left' },
    { id: 'D4',   label: 'D4 (PD13)',  type: PIN_TYPE.DIGITAL, x: 18, y: 230, side: 'left' },
    { id: 'D5',   label: 'D5 (PD14)',  type: PIN_TYPE.PWM,     x: 18, y: 249, side: 'left' },
    { id: 'D6',   label: 'D6 (PD15)',  type: PIN_TYPE.PWM,     x: 18, y: 268, side: 'left' },
    { id: 'GND1', label: 'GND',        type: PIN_TYPE.GND,     x: 18, y: 287, side: 'left' },

    // ── Right Arduino connector (vertical) ──
    { id: 'D7',   label: 'D7 (PG11)',  type: PIN_TYPE.DIGITAL, x: 462, y: 35,  side: 'right' },
    { id: 'D8',   label: 'D8 (PG12)',  type: PIN_TYPE.DIGITAL, x: 462, y: 54,  side: 'right' },
    { id: 'D9',   label: 'D9 (PB8)',   type: PIN_TYPE.PWM,     x: 462, y: 73,  side: 'right' },
    { id: 'D10',  label: 'D10 (PB10)', type: PIN_TYPE.PWM,     x: 462, y: 92,  side: 'right' },
    { id: 'D11',  label: 'D11 (PE5)',  type: PIN_TYPE.PWM,     x: 462, y: 111, side: 'right' },
    { id: 'D12',  label: 'D12 (PE6)',  type: PIN_TYPE.DIGITAL, x: 462, y: 130, side: 'right' },
    { id: 'D13',  label: 'D13 (PI1)',  type: PIN_TYPE.DIGITAL, x: 462, y: 154, side: 'right' },
    { id: 'D14',  label: 'D14 (PB9)',  type: PIN_TYPE.SIGNAL,  x: 462, y: 179, side: 'right' },
    { id: 'D15',  label: 'D15 (PB8)',  type: PIN_TYPE.SIGNAL,  x: 462, y: 198, side: 'right' },
    ...
    { id: 'PB6',  label: 'PB6 (I2C1)', type: PIN_TYPE.SIGNAL,  x: 150, y: 310, side: 'bottom' },
    { id: 'PB7',  label: 'PB7 (I2C1)', type: PIN_TYPE.SIGNAL,  x: 210, y: 310, side: 'bottom' },
    { id: 'PA9',  label: 'PA9 (USB)',  type: PIN_TYPE.SIGNAL,  x: 270, y: 310, side: 'bottom' },
    { id: 'PA10', label: 'PA10 (USB)', type: PIN_TYPE.SIGNAL,  x: 330, y: 310, side: 'bottom' },
