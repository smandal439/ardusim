...
window.loadExamplesFromFiles = async function () {
  ...
  const files = [
    '7408_test_with_logic_analyzer', '8085_assignment_1', '8085_assignment_2', '8085_assignment_3', '8085_assignment_4', '8085_assignment_5',
    '8085_assignment_6', '8085_assignment_7', '8085_assignment_8', '8085_assignment_9', 'add_2_number', 'and_gate',
    'astable_555', 'bh1750_light_sensor', 'blink', 'bluetooth_serial_bridge', 'button', 'buzzer_melody',
    'coap_client', 'coap_dip_switch_to_8_led', 'coap_simple_server', 'continuous_rotation_servo_control_by_pot', 'counter', 'current_divider',
    'dc_motor_speed', 'dht11_temperature_humidity', 'dip_switch_and_led_array', 'dip_switch_binary', 'dmm_current', 'dmm_resistance',
    'dmm_voltage', 'ds3231_rtc_clock', 'ds3231_rtc_clock_sync_with_ntp', 'dso_oscilloscope', 'dual_core_mqtt', 'esp32_blink',
    'esp32_dual_core_blink', 'esp32_fade', 'esp32_freertos_queue', 'esp32_gpio_control', 'esp32_gpio_control_dashboard', 'esp32_hub75_matrixpaneli2s_dma',
    'esp32_i2s_local_radio_player', 'esp32_i2s_music_player', 'esp32_i2s_online_radio_player', 'esp32_i2s_online_radio_player copy', 'esp32_i2s_online_radio_player2', 'esp32_mqtt_pub_sub',
    'esp32_ntp_clock_lcd', 'esp32_sd_songs_player', 'esp32_server', 'esp32_web_server', 'esp_now_dip_switch_to_8_led', 'esp_now_sender_with_receiver',
    ...
    'ili9341', 'ina219_solar_tracker', 'intel_8051_blink', 'intel_8051_counter', 'intel_8051_multiply_2_numbers', 'intel_8051_multiply_from_memory',
    'intel_8051_serial_hello', 'intel_8085_blink', 'intel_8085_counter', 'intel_8085_serial_hello', 'interrupts_test', 'interrupts_test copy',
    ...
    'logic_analyzer_test', 'lora_sender_receiver', 'lpc2148_all_leds', 'lpc2148_binary_counter', 'lpc2148_blink', 'lpc2148_button',
    'lpc2148_dac_sine', 'lpc2148_pot_adc', 'lpc2148_serial_echo', 'lpc2148_serial_hello', 'lpc2148_serial_print', 'lpc2148_timer0_led',
    'lpc2148_uart1_echo', 'math_operations', 'max7219', 'morse', 'morse_code_using_serial_data', 'mpu6050_accel',
