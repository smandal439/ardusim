...
class ArduinoSimulator {
  ...
  transpile(code) {
    ...
    } else if (this.board === 'lpc2148') {
      // LPC2148: built-in LEDs on P0.12-P0.15; ADC on P0.26-P0.28
      js = js.replace(/\bLED_BUILTIN\b/g, '12');
    ...
    try {
      ...
      if (code.startsWith('//__8085_ASM_DATA__') || code.startsWith('//__8051_ASM_DATA__')) {
        ...
        if (is8085) {
          ...
          runtimeFns._init8085(data.hex, data.binary, data.segments);
      ...
      if (this.board === 'intel_8085' || this.board === 'intel_8051') {
        ...
        return { ok: false, error: 'Assembly library not loaded for ' + this.board };
      }
  ...
  _mpuReadRegs(start, qty) {
    ...
    const tempRaw = -3920; /* deg  25 °C // raw/340 + 36.53 */
    const regs = {};
    const put16 = (a, v) => {
...
window.loadExamplesFromFiles = async function () {
  // 1. Try the Node server API (gives fresh results during local dev)
  try {
  ...
  } catch (e) { /* static hosting -- no server API */ }

  // 2. Use bundled examples (generated by build-examples.bat / examples-data.js)
  if (Array.isArray(window.EXAMPLE_SKETCHES) && window.EXAMPLE_SKETCHES.length > 0) {
    console.log('[ArduSim] Loaded ' + window.EXAMPLE_SKETCHES.length + ' examples from bundle');
    return;
  }
  ...
  const files = [
    ...
    '8085_sorting_descending', 'add_2_number', 'and_gate', 'astable_555', 'bh1750_light_sensor', 'blink',
    ...
    'dso_oscilloscope', 'dual_core_mqtt', 'esp32_blink', 'esp32_dual_core_blink', 'esp32_fade', 'esp32_freertos_queue',
    'esp32_gpio_control', 'esp32_gpio_control_dashboard', 'esp32_hub75_matrixpaneli2s_dma', 'esp32_i2s_local_radio_player', 'esp32_i2s_music_player', 'esp32_i2s_online_radio_player',
    'esp32_i2s_online_radio_player copy', 'esp32_i2s_online_radio_player2', 'esp32_mqtt_pub_sub', 'esp32_ntp_clock_lcd', 'esp32_sd_songs_player', 'esp32_server',
    'esp32_web_server', 'esp_now_dip_switch_to_8_led', 'esp_now_sender_with_receiver', 'espnow_led_control', 'espnow_receiver', 'espnow_sender',
    'fade_led_pwm', 'flex_sensor_bending_measurement', 'func_gen_dual', 'func_gen_led', 'gps_neo_6m_8m_tracker', 'hc05_bluetooth_led',
    'http_slider_pwm_led', 'hx711_load_cell_with_lcd_display', 'i8051_c_blink', 'i8051_c_timer0_isr', 'ic_nand_test', 'ili9341',
    'ina219_solar_tracker', 'intel_8051_blink', 'intel_8051_counter', 'intel_8051_multiply_2_numbers', 'intel_8051_multiply_from_memory', 'intel_8051_serial_hello',
    'intel_8051_timer0_interrupt', 'intel_8085_blink', 'intel_8085_counter', 'intel_8085_serial_hello', 'interrupts_test', 'interrupts_test copy',
    'inverting_amplifier', 'ir_dfplayer_remote', 'ir_obstacle_sensor_led_alert', 'ir_remote_decode', 'ir_remote_decoder', 'ir_remote_lcd',
    'joystick_led', 'keypad_interfacing', 'l298n_dc_motor', 'lcd', 'lcd_hello_world', 'lcd_i2c',
    'lcd_i2c_display_20x4', 'lcd_print_remotely', 'ldr_lamp', 'led_array_blink_pattern', 'lm35_temperature', 'lm35_temperature_sensor',
    'logic_analyzer_test', 'lora_sender_receiver', 'lora_weather_station', 'lpc2148_all_leds', 'lpc2148_binary_counter', 'lpc2148_blink',
    'lpc2148_button', 'lpc2148_dac_sine', 'lpc2148_pot_adc', 'lpc2148_serial_echo', 'lpc2148_serial_hello', 'lpc2148_serial_print',
    ...
    'oled_ssd1306', 'opamp_741_non_inverting', 'or_gate', 'pico2w_analog_read', 'pico2w_blink', 'pico2w_button',
    'pico2w_counter', 'pico2w_fade', 'pico2w_pwm', 'pico2w_rgb_led', 'pico2w_serial_hello', 'pico2w_wifi_scan',
    'pico_8led', 'pir_alarm', 'plugin_tutorial', 'potentiometer', 'print_binary_data', 'rainbow_rgb',
    'read_rfid_card_raw_data', 'relay_control', 'remote_control_leds', 'remote_servo_control', 'rfid_inventory_tracker', 'rgb_matrix_demo',
    'rotary_encoder_counter', 'rotary_encoder_servo', 'seg7_counter', 'serial_peek', 'serial_peek_2', 'serial_plotter',
    'serial_plotter_sine_and_triangle', 'servo_continuous_spin', 'servo_sweep', 'shift_resister_circuit', 'simplebme280_altimeter_on_lcd', 'simplebme280_altitude',
    'simplebme280_basic', 'stepper_motor', 'stm32f746_blink', 'stm32f746_button', 'stm32f746_hal_led_blink', 'stm32f746_lcd',
    'stm32f746_pot_led', 'stm32f746_register_uart', 'tb6600_stepper', 'traffic_light', 'two_lcd', 'u8g2_oled_example',
    'ultrasonic', 'ultrasonic_distance_pulsein', 'vl53l0x_proximity_sensor', 'voltage_divider', 'water_flow', 'weather_station_multi',
    'weather_station_simple', 'weather_station_tft', 'wifi_bssid', 'wifi_scan', 'zigbee_8_led_control', 'zigbee_led_control',
