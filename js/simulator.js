...
class ArduinoSimulator {
  ...
  transpile(code) {
    ...
    //     so plugin rules like esp_now_peer_info_t can match before Type->et stripping
    ...
    // Must run AFTER Type->et conversion so `let varname = {` is already formed
  ...
  _mpuReadRegs(start, qty) {
    ...
    const tempRaw = -3920; /* about 25 ->C -> raw/340 + 36.53 */
    const regs = {};
    const put16 = (a, v) => {
  ...
  _ds3231ReadRegs(start, qty) {
    ...
    const tempFrac = Math.round((temp - tempInt) * 4); /* 0.25 deg C steps -> 0..3 */
    const regs = {};
...
window.loadExamplesFromFiles = async function () {
  ...
  const files = [
    ...
    'esp32_mqtt_pub_sub', 'esp32_ntp_clock_lcd', 'esp32_sd_songs_player', 'esp32_server', 'esp_now_dip_switch_to_8_led', 'esp_now_sender_with_receiver',
    'espnow_led_control', 'espnow_receiver', 'espnow_sender', 'fade_led_pwm', 'flex_sensor_bending_measurement', 'func_gen_dual',
    'func_gen_led', 'gps_neo_6m_8m_tracker', 'hc05_bluetooth_led', 'http_slider_pwm', 'hx711_load_cell_with_lcd_display', 'ic_nand_test',
    'ili9341', 'ina219_solar_tracker', 'interrupts_test', 'interrupts_test copy', 'inverting_amplifier', 'ir_dfplayer_remote',
    'ir_obstacle_sensor_led_alert', 'ir_remote_decode', 'ir_remote_decoder', 'ir_remote_lcd', 'joystick_led', 'keypad_interfacing',
    'l298n_dc_motor', 'lcd', 'lcd_hello_world', 'lcd_i2c', 'lcd_i2c_display_20x4', 'lcd_print_remotely',
    'ldr_lamp', 'led_array_blink_pattern', 'lm35_temperature', 'lm35_temperature_sensor', 'logic_analyzer_test', 'lora_sender_receiver',
    'lpc2148_all_leds', 'lpc2148_binary_counter', 'lpc2148_blink', 'lpc2148_button', 'lpc2148_dac_sine', 'lpc2148_pot_adc',
    'lpc2148_serial_echo', 'lpc2148_serial_hello', 'lpc2148_serial_print', 'lpc2148_timer0_led', 'lpc2148_uart1_echo', 'math_operations', 'max7219',
    'morse', 'morse_code_using_serial_data', 'mpu6050_accel', 'mpu6050_accelerometer_2', 'multi_colour_led_blink', 'nano_blink',
    'neopixel_8x8_matrix_rainbow_2', 'neopixel_8x8_matrix_rainbow_3', 'neopixel_8x8_matrix_rainbow_4', 'neopixel_color_cycle', 'neopixel_strip_chase', 'neopixel_strip_color_pattern',
    'not_gate_test', 'ntc_thermistor_dc_motor', 'oled_ssd1306', 'opamp_741_non_inverting', 'or_gate', 'pir_alarm',
    'plugin_tutorial', 'potentiometer', 'print_binary_data', 'rainbow_rgb', 'read_rfid_card_raw_data', 'relay_control',
    'remote_control_leds', 'remote_servo_control', 'rfid_inventory_tracker', 'rgb_matrix_demo', 'rotary_encoder_counter', 'rotary_encoder_servo',
    'seg7_counter', 'serial_peek', 'serial_peek_2', 'serial_plotter', 'serial_plotter_sine_and_triangle', 'servo_continuous_spin',
    'servo_sweep', 'shift_resister_circuit', 'simplebme280_altimeter_on_lcd', 'simplebme280_altitude', 'simplebme280_basic', 'stepper_motor',
    'stm32f746_blink', 'stm32f746_button', 'stm32f746_hal_led_blink', 'stm32f746_lcd', 'stm32f746_pot_led', 'stm32f746_register_uart',
    'tb6600_stepper', 'traffic_light', 'two_lcd', 'u8g2_oled_example', 'ultrasonic', 'ultrasonic_distance_pulsein',
