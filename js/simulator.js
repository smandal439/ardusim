...
window.loadExamplesFromFiles = async function () {
  ...
  const files = [
    ...
    '8085_assignment_6', '8085_assignment_7', 'add_2_number', 'and_gate', 'astable_555', 'bh1750_light_sensor',
    'blink', 'bluetooth_serial_bridge', 'button', 'buzzer_melody', 'coap_client', 'coap_dip_switch_to_8_led',
    'coap_simple_server', 'continuous_rotation_servo_control_by_pot', 'counter', 'current_divider', 'dc_motor_speed', 'dht11_temperature_humidity',
    ...
    'esp32_i2s_online_radio_player', 'esp32_i2s_online_radio_player copy', 'esp32_i2s_online_radio_player2', 'esp32_mqtt_pub_sub', 'esp32_ntp_clock_lcd', 'esp32_sd_songs_player',
    'esp32_server', 'esp32_web_server', 'esp_now_dip_switch_to_8_led', 'esp_now_sender_with_receiver', 'espnow_led_control', 'espnow_receiver',
    'espnow_sender', 'fade_led_pwm', 'flex_sensor_bending_measurement', 'func_gen_dual', 'func_gen_led', 'gps_neo_6m_8m_tracker',
    'hc05_bluetooth_led', 'http_slider_pwm', 'hx711_load_cell_with_lcd_display', 'ic_nand_test', 'ili9341', 'ina219_solar_tracker',
    'intel_8051_blink', 'intel_8051_counter', 'intel_8051_multiply_2_numbers', 'intel_8051_multiply_from_memory', 'intel_8051_serial_hello', 'intel_8085_blink',
    'intel_8085_counter', 'intel_8085_serial_hello', 'interrupts_test', 'interrupts_test copy', 'inverting_amplifier', 'ir_dfplayer_remote',
    ...
    'lpc2148_serial_echo', 'lpc2148_serial_hello', 'lpc2148_serial_print', 'lpc2148_timer0_led', 'lpc2148_uart1_echo', 'math_operations',
    ...
    'stepper_motor', 'stm32f746_blink', 'stm32f746_button', 'stm32f746_hal_led_blink', 'stm32f746_lcd', 'stm32f746_pot_led',
    'stm32f746_register_uart', 'tb6600_stepper', 'traffic_light', 'two_lcd', 'u8g2_oled_example', 'ultrasonic',
    'ultrasonic_distance_pulsein', 'vl53l0x_proximity_sensor', 'voltage_divider', 'water_flow', 'weather_station_multi', 'weather_station_simple',
    'weather_station_tft', 'wifi_bssid', 'wifi_scan', 'zigbee_8_led_control', 'zigbee_led_control', 'zigbee_sender_receiver',
    'zigbee_sensor_network'
  ];
