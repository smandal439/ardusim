...
window.loadExamplesFromFiles = async function () {
  ...
  const files = [
    ...
    'pico2w_blink_2', 'pico2w_button', 'pico2w_counter', 'pico2w_fade', 'pico2w_pwm', 'pico2w_rgb_led',
    'pico2w_serial_hello', 'pico2w_wifi_scan', 'pico_8led', 'pir_alarm', 'plugin_tutorial', 'potentiometer',
