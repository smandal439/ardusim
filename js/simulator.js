...
window.loadExamplesFromFiles = async function () {
  ...
  const files = [
    ...
    'espnow_receiver', 'espnow_sender', 'fade_led_pwm', 'flex_sensor_bending_measurement', 'func_gen_dual', 'func_gen_led',
    'gps_neo_6m_8m_tracker', 'hc05_bluetooth_led', 'http_slider_pwm_led', 'hx711_load_cell_with_lcd_display', 'i8051_c_blink', 'i8051_c_timer0_isr',
    'ic_nand_test', 'ili9341', 'ina219_solar_tracker', 'intel_8051_blink', 'intel_8051_counter', 'intel_8051_multiply_2_numbers',
    'intel_8051_multiply_from_memory', 'intel_8051_serial_hello', 'intel_8051_timer0_interrupt', 'intel_8085_blink', 'intel_8085_counter', 'intel_8085_serial_hello',
    'interrupts_test', 'interrupts_test copy', 'inverting_amplifier', 'ir_dfplayer_remote', 'ir_obstacle_sensor_led_alert', 'ir_remote_decode',
    'ir_remote_decoder', 'ir_remote_lcd', 'joystick_led', 'keypad_interfacing', 'l298n_dc_motor', 'lcd',
    'lcd_hello_world', 'lcd_i2c', 'lcd_i2c_display_20x4', 'lcd_print_remotely', 'ldr_lamp', 'led_array_blink_pattern',
    'lm35_temperature', 'lm35_temperature_sensor', 'logic_analyzer_test', 'lora_sender_receiver', 'lora_weather_station', 'lpc2148_all_leds',
    'lpc2148_binary_counter', 'lpc2148_blink', 'lpc2148_button', 'lpc2148_dac_sine', 'lpc2148_pot_adc', 'lpc2148_serial_echo',
    'lpc2148_serial_hello', 'lpc2148_serial_print', 'lpc2148_timer0_led', 'lpc2148_uart1_echo', 'math_operations', 'max7219',
    ...
    'not_gate_test', 'ntc_thermistor_dc_motor', 'oled_ssd1306', 'opamp_741_non_inverting', 'or_gate', 'pico2w_blink',
    'pico2w_button', 'pico2w_counter', 'pico2w_fade', 'pico2w_serial_hello', 'pico2w_wifi_scan', 'pico_2_w_analog_read',
    'pico_2_w_rgb_led', 'pico_8led', 'pir_alarm', 'plugin_tutorial', 'potentiometer', 'print_binary_data',
