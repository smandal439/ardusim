...
window.loadExamplesFromFiles = async function () {
  ...
  const files = [
    ...
    'oled_ssd1306', 'opamp_741_non_inverting', 'or_gate', 'pico2w_analog_read', 'pico2w_blink', 'pico2w_blink_1',
    'pico2w_blink_2', 'pico2w_button', 'pico2w_counter', 'pico2w_fade', 'pico2w_rgb_led', 'pico2w_serial_hello',
    'pico2w_wifi_scan', 'pico_2_w_wifi_scan', 'pico_8led', 'pir_alarm', 'plugin_tutorial', 'potentiometer',
    ...
    'stm32f746_hal_led_blink', 'stm32f746_lcd', 'stm32f746_pot_led', 'stm32f746_register_uart', 'tb6600_stepper', 'traffic_light',
    'two_lcd', 'u8g2_oled_example', 'ultrasonic', 'ultrasonic_distance_pulsein', 'vl53l0x_proximity_sensor', 'voltage_divider',
    'water_flow', 'weather_station_multi', 'weather_station_simple', 'weather_station_tft', 'wifi_bssid', 'wifi_scan',
