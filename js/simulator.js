...
window.loadExamplesFromFiles = async function () {
  ...
  const files = [
    ...
    'dmm_resistance', 'dmm_voltage', 'ds3231_rtc_clock', 'ds3231_rtc_clock_sync_with_ntp', 'dso_oscilloscope', 'dual_core_mqtt',
    'esp32_blink', 'esp32_dual_core_blink', 'esp32_fade', 'esp32_freertos_queue', 'esp32_gpio_control', 'esp32_gpio_control_dashboard',
    ...
    'ir_remote_lcd', 'joystick_led', 'keypad_interfacing', 'l298n_dc_motor', 'lcd', 'lcd_hello_world',
    'lcd_i2c', 'lcd_i2c_display_20x4', 'lcd_print_remotely', 'ldr_lamp', 'led_array_blink_pattern', 'lm35_temperature',
    'lm35_temperature_sensor', 'logic_analyzer_test', 'lora_sender_receiver', 'lpc2148_all_leds', 'lpc2148_binary_counter', 'lpc2148_blink',
    ...
    'pico2w_counter', 'pico2w_fade', 'pico2w_rgb_led', 'pico2w_serial_hello', 'pico2w_wifi_scan', 'pir_alarm',
